...
export default {
  ...
  signOut(context) {
    ...
    context.commit('UPDATE_USER_LOGIN_INFO', '')
  },
  ...
  loadCarouselItems(context) {
    return new Promise((resolve, reject) => {
      ...
      context.commit('SET_CAROUSEL_ITEMS_INFO', data);
    });
  },
  ...
  loadEat(context) {
    return new Promise((resolve, reject) => {
      ...
      context.commit('SET_EAT_INFO', eat);
    });
  },

  // 请求获得商品详细信息
  loadGoodsInfo(context) {
  ...
  loadRecommend(context) {
    return new Promise((resolve, reject) => {
      ...
      context.commit('SET_RECOMMEND_INFO', data);
    });
  }
  ,
  ...
  loadShoppingCart(context) {
    return new Promise((resolve, reject) => {
      ...
      context.commit('SET_SHOPPING_CART', data);
    });
  }
}
